package me.scarlxrd.credit.application.system.controller

import me.scarlxrd.credit.application.system.dto.request.CustomerDto
...
import me.scarlxrd.credit.application.system.dto.request.CustomerUpdateDto
...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("scar"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("lxrd"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("scarlxrd.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua da chana, 123"))
    ...
    private fun builderCustomerDto(
        firstName: String = "Scar",
        lastName: String = "Lxrd",
        cpf: String = "28475934625",
        email: String = "scarlxrd@email.com",
        income: BigDecimal = BigDecimal.valueOf(1000.0),
        password: String = "1234",
        zipCode: String = "000000",
        street: String = "Rua da chana, 123",
    ) = CustomerDto(
        firstName = firstName,
        lastName = lastName,
        cpf = cpf,
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "ScarUpdate",
        lastName: String = "LxrdUpdate",
